...
def getTickets(domain,params,zendesk_headers,AWS_key,AWS_secret,AWS_bucket,binding_key,AWS_path):
	dfRequesters = getFile(AWS_path + 'requesters_zendesk_support_file.csv',AWS_key,AWS_secret,AWS_bucket).copy(deep=True)
	dfOrgs = getFile(AWS_path + 'orgs_zendesk_support_file.csv',AWS_key,AWS_secret,AWS_bucket).copy(deep=True)
	payload={}
	...
	FileOutput(dfRequesters,AWS_path + 'requesters_zendesk_support_file.csv',AWS_key,AWS_secret,AWS_bucket,True)
	FileOutput(dfOrgs,AWS_path + 'orgs_zendesk_support_file.csv',AWS_key,AWS_secret,AWS_bucket,True)
	return dfTickets